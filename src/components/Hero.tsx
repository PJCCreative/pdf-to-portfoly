  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-white/15 rounded-full animate-float" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-white/10 rounded-full animate-float" style={{ animationDelay: '2s' }} />
      </div>
          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Button 
                size="lg" 
                variant="secondary"
                className="glass-effect border-white/20 text-white hover:bg-white/20 transition-smooth"
                asChild
              >
